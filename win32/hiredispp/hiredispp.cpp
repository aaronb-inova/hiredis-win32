 ...
 * It has been modified to allow compilation without boost and therefore without UNICODE(wchar)
 *  support.
 */
...
#include <#include <boost/archive/detail/utf8_codecvt_facet.hpp>
#endif
